...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 8239;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreReminderPendinIntent = PendingIntent.getService(context,
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent incrementWaterCountPendinIntent = PendingIntent.getService(context,
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(
                ...
                "I did it.",
                incrementWaterCountPendinIntent);
